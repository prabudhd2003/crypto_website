    ...
    return (
        <div className='featured'>
            <div className='container'>
                {/* LEFT SIDE */}
                <div className='left'>
                    <h2>Explore top Cryto's Like Bitcoin, Ethereum, and Dogecoin</h2>
                ...
                <div className='right'>
                    <div className='card'>
                        <div className='top'>
                            <img src={data[0].image} alt="bitcoin-logo" />
                        </div>
                        <div>
                            <h5>{data[0].name}</h5>
                    ...
                    <div className='card'>
                        <div className='top'>
                            <img src={data[1].image} alt="bitcoin-logo" />
                        </div>
                        <div>
                            <h5>{data[1].name}</h5>
                    ...
                    <div className='card'>
                        <div className='top'>
                            <img src={data[2].image} alt="bitcoin-logo" />
                        </div>
                        <div>
                            <h5>{data[2].name}</h5>
                    ...
                    <div className='card'>
                        <div className='top'>
                            <img src={data[3].image} alt="bitcoin-logo" />
                        </div>
                        <div>
                            <h5>{data[3].name}</h5>
                    ...
                    <div className='card'>
                        <div className='top'>
                            <img src={data[4].image} alt="bitcoin-logo" />
                        </div>
                        <div>
                            <h5>{data[4].name}</h5>
                    ...
                    <div className='card'>
                        <div className='top'>
                            <img src={data[5].image} alt="bitcoin-logo" />
                        </div>
                        <div>
                            <h5>{data[5].name}</h5>
